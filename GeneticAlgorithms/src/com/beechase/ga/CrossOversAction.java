...
/**
 * Servlet implementation class CrossOversAction
 */
public class CrossOversAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CrossOversAction() {
        super();
...
//	    out.println("</link>");
	    ...
	    out.println("<h2><u>Distribution of Cross over count over the generations</u></h2>");
...
//	    out.println("lines: { show: true, steps: true, fill: true }, points: {show: true}");
	    out.println("},");
//    	out.println(" {");
//	 	out.println("data: d2, " + "label: \"Mutations(y-axis) over Generations(x-axis)\", yaxis:2 ");
